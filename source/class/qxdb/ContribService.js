...
qx.Class.define("qxdb.ContribService",
{
  ...
  construct : function() {
    ...
    this.__indexStore = new qx.data.store.Json(qxdb.ContribService.BASE_URL);
  ...
  members :
  {
    ...
    getTableData : function(contribName, forceReload)
    {
      var BASE_URL = qxdb.ContribService.BASE_URL,
