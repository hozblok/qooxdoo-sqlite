...
qx.Class.define("qxdb.FormItems", {
  ...
  members:
    {
      ...
      __createContribSelectionFields: function (form) {
        ...
        form.add(this.__contribBox, "database table:");

        this.__contribBox.addListener("changeSelection", function () {
          var selection = this.__contribBox.getSelection();
          if (selection.length === 0) {
            return;
          }
          var curSelectedContrib = selection[0].getLabel();
          this.tableName = curSelectedContrib;
          this.fireDataEvent("datatableSelected", curSelectedContrib);
        }, this);
      },

      updateContribFormWith: function (contribModel) {
        var obj = qx.util.Serializer.toNativeObject(contribModel);
        var formattedJson = qxdb.Util.getFormattedJson(obj);
      ...
      updateContribIndex: function (qxModel) {
        ...
        console.log("allContribNames", allContribNames);
        ...
        this.__contribBoxController.setModel(model);
      },
